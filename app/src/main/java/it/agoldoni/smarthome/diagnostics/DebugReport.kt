...
internal class DebugReport(
    ...
    private fun device(device: Device, state: DeviceState?, subscriptions: Map<String, Int>) =
        JSONObject().apply {
            ...
            put("payloads", JSONObject().apply {
                ...
                putOrNull("energyYesterdayJsonKey", device.energyYesterdayJsonKey)
                putOrNull("energyWeekJsonKey", device.energyWeekJsonKey)
    ...
    private fun deviceState(state: DeviceState?) = JSONObject().apply {
        ...
        putOrNull("kwhYesterday", state.kwhYesterday)
        putOrNull("kwhWeek", state.kwhWeek)
